...
class EventController extends Controller
{
    ...
    public function sendEventHist3()
    {
        // Mendapatkan data terakhir dari tabel TBL_SIGEVENT_HIST_RT0005
        $data = DB::table('TBL_SIGEVENT_HIST_RT0003')->orderBy('sig_hist_idx', 'desc')->take(20)->get();
    ...
    public function sendEventHist4()
    {
        // Mendapatkan data terakhir dari tabel TBL_SIGEVENT_HIST_RT0005
        $data = DB::table('TBL_SIGEVENT_HIST_RT0004')->orderBy('sig_hist_idx', 'desc')->take(20)->get();
    ...
    public function sendEventHist5()
    {
        // Mendapatkan data terakhir dari tabel TBL_SIGEVENT_HIST_RT0005
        $data = DB::table('TBL_SIGEVENT_HIST_RT0005')->orderBy('sig_hist_idx', 'desc')->take(20)->get();
